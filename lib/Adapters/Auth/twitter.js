...
class TwitterAuthAdapter extends _AuthAdapter.default {
  ...
  async validateAuthData(authData, options) {
    ...
    if (accessTokenData !== null && accessTokenData !== void 0 && accessTokenData.oauth_token && accessTokenData !== null && accessTokenData !== void 0 && accessTokenData.user_id) {
  ...
  async validateInsecureAuth(authData, options) {
    ...
    if ((parsedData === null || parsedData === void 0 ? void 0 : parsedData.id) === authData.id) {
      return;
    }
    throw new Parse.Error(Parse.Error.OBJECT_NOT_FOUND, 'Twitter auth is invalid for this user.');
  }
