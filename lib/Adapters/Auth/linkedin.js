  ...
  async getUserFromAccessToken(access_token, authData) {
    const response = await fetch('https://api.linkedin.com/v2/me', {
      headers: {
        ...
        'x-li-format': 'json',
        'x-li-src': authData !== null && authData !== void 0 && authData.is_mobile_sdk ? 'msdk' : undefined
      }
    });
    if (!response.ok) {
